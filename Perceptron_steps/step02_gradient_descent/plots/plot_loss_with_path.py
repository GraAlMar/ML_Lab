...
# Mark endpoint
ax.plot([history_w[-1]], [history_b[-1]], [history_loss[-1]],
         "gX", markersize=16)

# Mark startpoint and path
ax.plot([history_w[0]], [history_b[0]], [history_loss[0]], "wo")
ax.plot(history_w, history_b, history_loss, color="w", linestyle="dashed")
plt.draw()
plt.show()
